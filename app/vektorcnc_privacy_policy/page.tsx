export default function VektorCncPrivacyPolicyPage() {
  return (
    <section className="container-main page-content-template pb-20 pt-6">
      ...
      <h1 className="section-title">VektorCNC Gizlilik Politikası</h1>
      <div className="page-body mt-6 max-w-4xl space-y-6 text-white/80">
        <p>
          Bu Gizlilik Politikası, Google Play üzerinden yayınlanan VektorCNC mobil uygulamasını kullanan
          tüm kullanıcılar için hazırlanmıştır. VektorCNC ve ilgili dijital hizmetler VektorHUB tarafından
          sunulmaktadır.
        </p>
        <p>
        ...
        <div>
          ...
          <p className="mt-3">Uygulama deneyimini güvenli ve işlevsel tutmak amacıyla aşağıdaki veri kategorileri işlenebilir:</p>
          <ul className="mt-3 list-disc space-y-2 pl-6">
            <li>Kimlik ve iletişim bilgileri (ad, soyad, e-posta, telefon gibi kullanıcının paylaştığı bilgiler).</li>
            <li>Hesap ve oturum bilgileri (kullanıcı ID, giriş durumu, yetkilendirme kayıtları).</li>
            <li>Teknik veriler (cihaz modeli, işletim sistemi sürümü, uygulama sürümü, dil, saat dilimi).</li>
            <li>Kullanım verileri (uygulama içi ekran geçişleri, işlem logları, hata kayıtları, performans verileri).</li>
            <li>Destek ve iletişim kayıtları (talep, geri bildirim, teknik destek yazışmaları).</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-3">
            Uygulama, yalnızca ilgili özelliğin çalışması için gerekli olduğunda cihaz izinleri talep eder.
            Talep edilen izinler, Android işletim sistemi üzerinden yönetilebilir ve dilediğiniz zaman
            düzenlenebilir.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6">
            <li>Hizmetin teknik olarak sunulabilmesi için çalışılan altyapı, sunucu veya analitik hizmet sağlayıcıları.</li>
            <li>Mevzuat gereği yetkili kamu kurum ve kuruluşları.</li>
            <li>Hukuki süreç, denetim veya güvenlik ihtiyaçları kapsamında yetkili merciler.</li>
          </ul>
          <p className="mt-3">
            Tüm paylaşımlar, amaçla sınırlı ve gerekli olduğu ölçüde yapılır; teknik ve idari koruma
        ...
        <div>
          ...
          <p className="mt-3">
            Veriler, işleme amacının gerektirdiği süre boyunca ve ilgili mevzuatta öngörülen yasal saklama
            süreleri kadar muhafaza edilir. Süre dolduğunda veriler silinir, yok edilir veya anonim hale getirilir.
          </p>
        </div>

        <div>
          <h2 className="section-subtitle text-white">7. Veri Güvenliği</h2>
          <p className="mt-3">VektorHUB, kişisel verilerin güvenliğini sağlamak için makul teknik ve idari tedbirler uygular:</p>
          <ul className="mt-3 list-disc space-y-2 pl-6">
            <li>Erişim yetkilerinin sınırlandırılması ve rol bazlı kontrol.</li>
            <li>Loglama, izleme ve güvenlik denetimleri.</li>
            <li>Güncel yazılım ve altyapı güvenlik önlemleri.</li>
            <li>Veri işleyen personel ve iş ortakları için gizlilik yükümlülükleri.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-3">
            ...
            yanlışlıkla işlendiğinin tespiti halinde ilgili veriler makul sürede silinir.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-3">
            ...
            iletebilirsiniz. Başvurular, mevzuatta belirtilen süreler içinde değerlendirilir.
          </p>
        </div>
