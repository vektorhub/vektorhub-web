const supportAreas = [
  {
    title: "Takip Alanları",
    description:
      "Basit müşteri takip alanları, bilgi formları ve iletişim akışlarının dijitalleşmesi.",
  },
  {
    title: "Süreç Araçları",
    description:
      "Teklif, talep veya başvuru süreçlerini kolaylaştıran küçük ölçekli dijital yardımcı yapılar.",
  },
  {
    title: "Operasyon Desteği",
    description:
      "İşletmenin temel operasyonlarını daha düzenli yürütecek hafif ve sürdürülebilir sistemler.",
  },
];
    ...
    <section className="container-main page-content-template pb-20 pt-6">
      ...
      >
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/72 sm:text-lg">
            ...
            günlük iş akışını toparlayan, iletişimi kolaylaştıran ve takibi daha düzenli hale
            getiren küçük ama etkili dijital çözümlerdir.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl">
        ...
        <p className="mt-5 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
          VektörHUB bu noktada, işletmenin yapısına uygun pratik çözümler kurgular. Amaç, gereksiz
          karmaşıklık üretmek değil; gerçekten kullanılan ve işi kolaylaştıran bir yapı kurmaktır.
        </p>
      </div>
      ...
      <div className="mt-10 max-w-4xl rounded-[28px] border border-orange-500/15 bg-orange-500/[0.06] p-6 sm:p-7">
        ...
        <p className="mt-4 text-base leading-8 text-white/76 sm:text-lg">
          Buradaki hedef büyük bir teknoloji yatırımı değil; küçük işletmenin elini güçlendiren,
